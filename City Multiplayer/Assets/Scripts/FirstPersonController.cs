...
public class FirstPersonController : NetworkBehaviour
{
    ...
    {  
        ...
        //Check if client is connected and display menu on ESC
        if (!IsOwner) return;
        #region Menu
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.playerCamera = (Camera)EditorGUILayout.ObjectField(new GUIContent("Camera", "CameraAttached"), fpc.playerCamera, typeof(Camera), true);
        fpc.menuDisplay = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Menu", "MenuAttached"), fpc.menuDisplay, typeof(GameObject), true);
